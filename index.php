...
<html>
  <head>
   ...
   <?
      ...
      function Caldate($icalDate)          # gibt Datum formatiert
      { 
    ...
    <div data-role="page">
     ...
     ?>
          <div data-role="navbar" data-iconpos="left">
              <ul>      
                  <li><a href="#wann<? $_SERVER['PHP_SELF'] ?>" data-transition="pop" class="ui-btn ui-corner-all ui-shadow ui-btn-inline  ui-btn-icon-left" data-icon="calendar">Wann?<br><? echo Caldate($datum_geted); ?></a></li>
    ...
    <div data-role="page" id="impressum" data-theme="a">
      ...
      <div role="main" class="ui-content">
           ...
           <ul>
            ...
            <li>ICS-Parser: <a href="https://github.com/johngrogg/ics-parser" target="_blank">ics-parser</a></li> 
            <li>Layout: <a href="http://jquerymobile.com" target="_blank">jQuery Mobile</a></li>  
            <li>Datepicker: <a href="https://github.com/arschmitz/jquery-mobile-datepicker-wrapper" target="_blank">jQuery Mobil Datepicker</a></li>   
           </ul>    
          </div>  
      </div><!-- /content -->
...
<script>
  ...
  ga('create', 'UA-1241347-4', 'vwi.org');
  ga('send', 'pageview');
